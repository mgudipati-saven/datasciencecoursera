...
The tidy data set contains average values for all mean() and std() variables from the raw data set for each subject and each activity. Hence it contains 6 * 30 = 180 rows(observations) and 68 columns(variables).
...
The rest of the columns are aggregations of mean, std measurements:
